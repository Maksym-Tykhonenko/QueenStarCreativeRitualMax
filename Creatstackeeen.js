...
import FrostCurrentCore from './QueenStarCreativeRitualSrc/RatenueitPascegs/OsertishWrapIcingCatch';
import PolarIntroDrift from './QueenStarCreativeRitualSrc/RatenueitPascegs/QueenStarCreativeRitualOnboarding';
import ArcticBootVeil from './QueenStarCreativeRitualSrc/RatenueitPascegs/QueenStarCreativeRitualLoading';
...
const CryoRouteSpindle = () => {
  ...
  const Route = ({ isFatch }) => {
    ...
    return (
      <SpindleNavigator
        ...
        initialRouteName="QueenStarCreativeRitualOnboarding"
      >
        <SpindleScreen
          name="QueenStarCreativeRitualLoading"
        ...
        <SpindleScreen
          name="QueenStarCreativeRitualOnboarding"
  ...
  return (
    <BorealNavSphere>
      {!isLoading ? <ArcticBootVeil /> : <Route isFatch={route} />}
    </BorealNavSphere>
  );
};
